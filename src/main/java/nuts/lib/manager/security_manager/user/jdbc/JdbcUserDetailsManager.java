...
import nuts.lib.manager.security_manager.user.jdbc.builder.JdbcUserDetailsManagerTableConfigurer;
...
/**
 * In connection with the database, it is responsible for providing and managing Spring Security user information.
 * <p>
 * It is intended to be created using a builder class, and it is recommended to register and use it as a spring bean.
 *
 * @creation 2024. 06. 13
 */
@Slf4j
public class JdbcUserDetailsManager implements UserDetailsService {
    ...
    public JdbcUserDetailsManager(JdbcTemplate jdbcTemplate, TransactionTemplate transactionTemplate,
                                  JdbcUserDetailsManagerTableConfigurer.UserTableConfigurer userTableInfoConfigurer, JdbcUserDetailsManagerTableConfigurer.AuthorityTableConfigurer authorityTableInfoConfigurer,
